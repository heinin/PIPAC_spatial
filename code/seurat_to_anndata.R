...
cell_seurat_data <- readRDS("/scratch/hnatri/PIPAC/immune_seurat_data.rds")
...
SaveH5Seurat(cell_seurat_data, filename = "/scratch/hnatri/PIPAC/RSC_latest_EDM_2025-08-06/immune.h5Seurat", overwrite = TRUE)
Convert("/scratch/hnatri/PIPAC/RSC_latest_EDM_2025-08-06/immune.h5Seurat", dest = "h5ad", overwrite = TRUE)
