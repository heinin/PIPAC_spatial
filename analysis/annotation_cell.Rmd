...
write.table(output_cluster_markers, "/home/hnatri/PIPAC_spatial/cell_main_cluster_marker_annotations_denoist.tsv",
...
write.table(output_cluster_markers, "/home/hnatri/PIPAC_spatial/cell_annotation_top_markers_denoist.tsv",
            quote = F, row.names = F, sep = "\t")
...
seurat_data$Lineage <- ifelse(seurat_data$leiden_res0.5 %in% c(2, 4, 6, 7, 12, 14),
                              "Immune", "TumorStroma")
