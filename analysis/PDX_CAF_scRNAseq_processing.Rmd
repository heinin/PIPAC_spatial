...
smoothScatter(log2(seurat_merged$nCount_SoupX_RNA), log2(seurat_merged$nFeature_SoupX_RNA),
              xlab = "log2(nCount_SoupX_RNA)", ylab = "log2(nFeature_SoupX_RNA)")

smoothScatter(seurat_merged$nCount_SoupX_RNA, seurat_merged$nFeature_SoupX_RNA,
